...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (day >= 32)
            {
                System.out.println("You've wasted enough campus resources and you didn't do anything. No one respects you anymore and you end up in deep depression.\n Eventually your grades force you to quit campus: \n \nSecret Ending: Drop Out");
                break;
            }
        }
    }
